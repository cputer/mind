...
from _diagnostic_project import assert_unscoped_import_refused, write_fixture  # noqa: E402
...
def live_diags(mindc, src, workdir, idx):
    path = write_fixture(src, workdir, idx, local_project=src == S_IMPORT_LOCAL)
...
def main():
    ...
    with tempfile.TemporaryDirectory() as workdir:
        ...
        assert_unscoped_import_refused(mindc, S_IMPORT_LOCAL, workdir)
