...
//!
//! Exercises the shipped binary's signing and verification paths, with
//! explicit tamper, key-pinning, malformed-input and downgrade controls.
//!
//! Seeds here are fixed TEST values embedded in source. No production key is
//! required. Production key custody remains separate.

#![cfg(all(feature = "evidence-mldsa", feature = "evidence-slhdsa"))]

use std::process::Command;

#[path = "support/pqc_hybrid_cli_support.rs"]
mod support;
use support::*;
