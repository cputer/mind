...
**Project:** `mind`
**Files:** 1648 | **Est. tokens:** ~3123723
**Generated:** 2026-09-07 00:08 UTC
...
- `exec_semantics_gate.sh` (~10180 tok, huge) — exec_semantics_gate.sh — run the test tiers CI could not reach, and PROVE they ran.
