...
**Project:** `mind`
**Files:** 1743 | **Est. tokens:** ~3,403,734
...
| `examples/mindc_mind/` | 172 | ~441,747 |
...
| `examples/mind_mirror_v04/` | 3 | ~15,904 |
| `examples/mind_mirror_v04/testdata/` | 1 | ~1,968 |
...
| `src/stdlib/` | 2 | ~560 |
| `src/test/` | 4 | ~14,244 |
| `src/type_checker/` | 17 | ~56,166 |
| `src/type_checker/slice_abi/` | 3 | ~10,768 |
| `src/types/` | 10 | ~20,740 |
...
- `mic3_v04_prefix_mirror.mind` (~12198 tok, huge) — ===========================================================================
...
- `MANIFEST.tsv` (~1968 tok, huge) — # name	expected_exit	bytes	sha256	consumed	note
### `examples/`
...
- `v04_mirror_body_vectors.rs` (~801 tok, large) — Copyright 2025-2026 STARGA Inc.
...
- `v04_mirror_oracle.rs` (~4079 tok, huge) — Copyright 2025-2026 STARGA Inc.
### `tests/`
...
- `v04_mirror_vector_dump.rs` (~6745 tok, huge) — Copyright 2025-2026 STARGA Inc.
