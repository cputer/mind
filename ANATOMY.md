...
**Project:** `mind`
**Files:** 1473 | **Est. tokens:** ~2,862,767
**Generated:** 2026-09-04 21:37 UTC
...
- `exec_semantics_gate.sh` (~9230 tok, huge) — exec_semantics_gate.sh — run the test tiers CI could not reach, and PROVE they ran.
