...
**Project:** `mind`
**Files:** 1750 | **Est. tokens:** ~3445381
**Generated:** 2026-09-09 14:30 UTC
...
| `examples/mind_mirror_v04/` | 3 | ~26440 |
| `examples/mind_mirror_v04/testdata/` | 2 | ~3601 |
...
- `mic3-v04-draft.md` (~1853 tok, huge) — MIC3 `0x04` core codec — implementation draft
...
- `mic3_v04_prefix_mirror.mind` (~22605 tok, huge) — ===========================================================================
...
- `SEMANTIC_MANIFEST.tsv` (~886 tok, large) — # name	expected_exit	bytes	sha256	consumed	note
### `examples/mindc_mind/`
...
- `v04_value_id_boundary.rs` (~3355 tok, huge) — Copyright 2025-2026 STARGA Inc.
