...
**Project:** `mind`
**Files:** 1466 | **Est. tokens:** ~2,800,726
...
| `examples/mindc_mind/` | 165 | ~408,268 |
...
- `mic3_oracle_smoke.py` (~863 tok, large) — mic@3 self-host convergence — Phase 0 gate: the Rust oracle.
...
- `smoke_wiring_lint.py` (~3978 tok, huge) — smoke_wiring_lint.py — machine-checked contract for WHERE each
...
- `gate_assert_count_contract_test.py` (~3267 tok, huge) — Gate test: the assertion count must be EVIDENCE, never a printed integer.
