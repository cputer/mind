...
- `neg_bad_magic.mic3` (~26 tok, tiny) — MIC4	PairalphaentrymainownerAownerBstepxzeta
- `neg_bad_return_present_tag.mic3` (~12 tok, tiny) — MIC3__mind_intrinsicentrymainother
- `neg_bad_utf8_string.mic3` (~3 tok, tiny) — MIC3�(
- `neg_duplicate_field.mic3` (~17 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_duplicate_strings.mic3` (~5 tok, tiny) — MIC3alphaalpha
- `neg_dynamic_over_boundary.mic3` (~10 tok, tiny) — MIC3ABf��@��@
- `neg_empty_schema_owner.mic3` (~6 tok, tiny) — MIC3Pairf
- `neg_function_cumulative_elements.mic3` (~14 tok, tiny) — MIC3entrymain�� ��@�� ��@
- `neg_intrinsic_missing_return.mic3` (~14 tok, tiny) — MIC3__mind_intrinsic	store_i64
- `neg_intrinsic_without_reserved_owner.mic3` (~12 tok, tiny) — MIC3__mind_intrinsicentrymainother
- `neg_intrinsic_wrong_arity.mic3` (~13 tok, tiny) — MIC3__mind_intrinsicload_i64
- `neg_intrinsic_wrong_param_type.mic3` (~13 tok, tiny) — MIC3__mind_intrinsicload_i64
- `neg_intrinsic_wrong_return_type.mic3` (~13 tok, tiny) — MIC3__mind_intrinsicload_i64
- `neg_non_minimal_surface.mic3` (~26 tok, tiny) — MIC3�	PairalphaentrymainownerAownerBstepxzeta
- `neg_overlong_surface.mic3` (~29 tok, tiny) — MIC3������������	PairalphaentrymainownerAownerBstepxzeta
- `neg_path_like_function_owner.mic3` (~6 tok, tiny) — MIC3A..Bmain
- `neg_path_like_schema_owner.mic3` (~7 tok, tiny) — MIC3A..BPairf
- `neg_reserved_owner_not_intrinsic.mic3` (~12 tok, tiny) — MIC3__mind_intrinsicentrymainother
- `neg_schema_cumulative_elements.mic3` (~14 tok, tiny) — MIC3ABabc�� ��@�� ��@
- `neg_schema_descriptor_product.mic3` (~11 tok, tiny) — MIC3ABf��������
- `neg_schema_ref_out_of_bounds.mic3` (~16 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_std_surface_required.mic3` (~26 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_string_count_overruns.mic3` (~3 tok, tiny) — MIC3����� 
- `neg_string_length_overruns.mic3` (~4 tok, tiny) — MIC3����� ab
- `neg_truncated_header.mic3` (~1 tok, tiny) — MIC3
- `neg_truncated_schema_headers.mic3` (~15 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_truncated_string_bytes.mic3` (~25 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_unknown_function_kind.mic3` (~12 tok, tiny) — MIC3__mind_intrinsicentrymainother
- `neg_unknown_intrinsic.mic3` (~12 tok, tiny) — MIC3__mind_intrinsicevil
- `neg_unknown_scalar_tag.mic3` (~16 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta	
- `neg_unknown_surface_bits.mic3` (~26 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_unknown_type_tag.mic3` (~16 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_unsorted_functions.mic3` (~14 tok, tiny) — MIC3__mind_intrinsicentrymainother
- `neg_unsorted_schemas.mic3` (~19 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_unsorted_strings.mic3` (~14 tok, tiny) — MIC3	alphaPairentrymainownerAownerBstepxzeta
- `neg_wrong_version.mic3` (~26 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `neg_zero_extent_hides_product.mic3` (~11 tok, tiny) — MIC3ABf��������
- `pos_full_body_element_boundary.mic3` (~10 tok, tiny) — MIC3ABf��@��@
- `pos_full_body_intrinsic_catalog.mic3` (~51 tok, small) — MIC3__mind_intrinsicallocargcargvload8load_i64openreadstore8	store_i
- `pos_full_body_long_string.mic3` (~57 tok, small) — MIC3�xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
- `pos_full_body_scoped.mic3` (~41 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
- `pos_full_body_small.mic3` (~6 tok, tiny) — MIC3T
- `pos_prefix_element_boundary.mic3` (~8 tok, tiny) — MIC3ABf��@��@
- `pos_prefix_empty_strings.mic3` (~3 tok, tiny) — MIC3
- `pos_prefix_long_string.mic3` (~53 tok, small) — MIC3�xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
- `pos_prefix_record_ref_cost_one.mic3` (~6 tok, tiny) — MIC3ABf
- `pos_prefix_scoped.mic3` (~26 tok, tiny) — MIC3	PairalphaentrymainownerAownerBstepxzeta
### `examples/mindc_mind/`
...
- `check_gate_wiring.py` (~9466 tok, huge) — Wiring lint: a whole-tree gate's CI trigger must cover every path it scans.
