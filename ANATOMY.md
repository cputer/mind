...
| `examples/mind_mirror_v04/` | 3 | ~28385 |
| `examples/mind_mirror_v04/testdata/` | 2 | ~3686 |
...
- `mic3-v04-draft.md` (~1885 tok, huge) — MIC3 `0x04` core codec — implementation draft
...
- `mic3_v04_prefix_mirror.mind` (~24550 tok, huge) — ===========================================================================
...
- `SEMANTIC_MANIFEST.tsv` (~971 tok, large) — # name	expected_exit	bytes	sha256	consumed	note
### `examples/mindc_mind/`
...
- `v04_value_id_boundary.rs` (~3650 tok, huge) — Copyright 2025-2026 STARGA Inc.
