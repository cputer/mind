...
**Project:** `mind`
**Files:** 1551 | **Est. tokens:** ~3027671
**Generated:** 2026-09-06 15:39 UTC
...
| `examples/mindc_mind/testdata/selfhost_loop/` | 2 | ~1928 |
...
- `self_host_tc_self_host_only_call_smoke.py` (~1940 tok, huge) — CPU-as-oracle smoke for the pure-MIND E2024 self-host-only-call rule.
...
- `bitwise_subset_refusal.rs` (~306 tok, medium) — The low-level subset must refuse bitwise syntax at the parser boundary.
...
- `phase_g_keystone_bootstrap.rs` (~7296 tok, huge) — Copyright 2025 STARGA Inc.
...
- `std_surface_net_fs_process.rs` (~8327 tok, huge) — Copyright 2025 STARGA Inc.
...
- `std_surface_vec_zeroed.rs` (~1092 tok, large) — Copyright 2025 STARGA Inc.
...
- `bench_gate.py` (~4319 tok, huge) — # Copyright 2025 STARGA Inc.
...
- `test_bench_gate.py` (~2894 tok, huge) — Regression test for the bench-gate fail-closed contract (tools/bench_gate.py).
