...
| `examples/mindc_mind/` | 167 | ~427794 |
...
- `gap_corpus_smoke.py` (~5656 tok, huge)
...
- `bench_gate.py` (~4153 tok, huge) — # Copyright 2025 STARGA Inc.
...
- `test_bench_gate.py` (~1589 tok, huge) — Regression test for the bench-gate fail-closed contract (tools/bench_gate.py).
