...
**Project:** `mind`
**Files:** 1670 | **Est. tokens:** ~3194455
**Generated:** 2026-09-08 04:27 UTC
...
- `struct_resolver.rs` (~8361 tok, huge) — Copyright 2025 STARGA Inc.
...
- `fixed_array_struct_field_run.rs` (~4638 tok, huge) — Copyright 2026 STARGA Inc.
### `tests/fixtures/`
